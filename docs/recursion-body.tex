...
\begin{tabular}{@{}llp{0.48\textwidth}@{}}
  ...
  Recursive1 & Circom + STARK & Verifies one Basic/Compressor STARK
                                inside a Circom (R1CS) circuit, proved with a STARK \\
  Recursive2 & Circom + STARK & Aggregates $\leq 3$ proofs of the same airgroup
