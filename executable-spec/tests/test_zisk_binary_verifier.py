"""Verifier E2E test for Binary AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_binary_verifier():
    """Verify Binary AIR proof from Fibonacci(10) guest program.

    Binary AIR handles bitwise operations (AND, OR, XOR, comparisons).
    """
    air_name = "Binary"
    proof_stem = "Binary_8"
