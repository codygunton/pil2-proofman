"""Verifier E2E test for RomData AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_romdata_verifier():
    """Verify RomData AIR proof from Fibonacci(10) guest program.

    RomData AIR handles ROM data segment access.
    """
    air_name = "RomData"
    proof_stem = "RomData_3"
