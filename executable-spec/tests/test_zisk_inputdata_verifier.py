"""Verifier E2E test for InputData AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_inputdata_verifier():
    """Verify InputData AIR proof from Fibonacci(10) guest program.

    InputData AIR handles input data and public inputs.
    """
    air_name = "InputData"
    proof_stem = "InputData_4"
