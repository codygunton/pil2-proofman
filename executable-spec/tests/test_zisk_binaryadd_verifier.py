"""Verifier E2E test for BinaryAdd AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_binaryadd_verifier():
    """Verify BinaryAdd AIR proof from Fibonacci(10) guest program.

    BinaryAdd AIR handles binary addition and subtraction operations.
    """
    air_name = "BinaryAdd"
    proof_stem = "BinaryAdd_7"
