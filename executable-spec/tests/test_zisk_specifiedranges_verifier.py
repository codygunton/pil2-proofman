"""Verifier E2E test for SpecifiedRanges AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_specifiedranges_verifier():
    """Verify SpecifiedRanges AIR proof from Fibonacci(10) guest program.

    SpecifiedRanges AIR handles range constraint checking.
    """
    air_name = "SpecifiedRanges"
    proof_stem = "SpecifiedRanges_9"
