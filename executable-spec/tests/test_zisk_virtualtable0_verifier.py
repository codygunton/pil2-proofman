"""Verifier E2E test for VirtualTable0 AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_virtualtable0_verifier():
    """Verify VirtualTable0 AIR proof from Fibonacci(10) guest program.

    VirtualTable0 AIR handles table lookup operations (table 0).
    """
    air_name = "VirtualTable0"
    proof_stem = "VirtualTable0_10"
