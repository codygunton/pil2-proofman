"""Verifier E2E test for Mem AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_mem_verifier():
    """Verify Mem AIR proof from Fibonacci(10) guest program.

    Mem AIR handles main memory reads and writes.
    """
    air_name = "Mem"
    proof_stem = "Mem_2"
