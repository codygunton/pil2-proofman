"""Verifier E2E test for Main AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_main_verifier():
    """Verify Main AIR proof from Fibonacci(10) guest program.

    Main AIR handles instruction dispatch and execution control flow.
    """
    air_name = "Main"
    proof_stem = "Main_0"
