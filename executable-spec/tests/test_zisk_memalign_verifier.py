"""Verifier E2E test for MemAlign AIR using GPU-generated proof from Fibonacci(10)."""
...
def test_memalign_verifier():
    """Verify MemAlign AIR proof from Fibonacci(10) guest program.

    MemAlign AIR handles aligned memory operations.
    """
    air_name = "MemAlign"
    proof_stem = "MemAlign_5"
